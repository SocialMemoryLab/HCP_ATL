...
outputDesc = [searchName defineROITask inputSuffix contrastName invertSuffix numSuffix subSuffix 'Sm4Discovery'];
...
%     maskPath = [funcDir '/' subject '_space-' statSpace '_desc-brainNonZero_mask' imageExt];
    ...
    searchPath = [groupDir '/MMPParcels/' subjStr 'space-' searchSpace '_desc-' searchName '_mask' imageExt];
