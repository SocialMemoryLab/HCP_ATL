...
% 
%
% Function derived from fpp to define regions-of-interest from a given task
% and participant, using ROIs defined by maximally responsive coordinates
% from a specific contrast in the same or another task, within a search
% space. 
% 
%
% Arguments:
...
function  hcpDefineROI(extractResponseDir,defineROIDir,contrastName,searchPath,varargin)
